...
#define BSP_LCD_HSYNC           (GPIO_NUM_3)
#define BSP_LCD_DE              (GPIO_NUM_16)
#define BSP_LCD_RST             (GPIO_NUM_NC)  /*< 没有接*/
#define BSP_LCD_PCLK            (GPIO_NUM_44)

#define BSP_LCD_DATA0           (GPIO_NUM_12)   // B0
#define BSP_LCD_DATA1           (GPIO_NUM_11)   // B1
#define BSP_LCD_DATA2           (GPIO_NUM_10)   // B2
#define BSP_LCD_DATA3           (GPIO_NUM_9)    // B3
#define BSP_LCD_DATA4           (GPIO_NUM_46)   // B4

#define BSP_LCD_DATA5           (GPIO_NUM_45)   // G0
#define BSP_LCD_DATA6           (GPIO_NUM_48)   // G1
#define BSP_LCD_DATA7           (GPIO_NUM_47)   // G2
#define BSP_LCD_DATA8           (GPIO_NUM_21)   // G3
#define BSP_LCD_DATA9           (GPIO_NUM_14)   // G4
#define BSP_LCD_DATA10          (GPIO_NUM_13)   // G5

#define BSP_LCD_DATA11          (GPIO_NUM_42)   // R0
#define BSP_LCD_DATA12          (GPIO_NUM_41)   // R1
#define BSP_LCD_DATA13          (GPIO_NUM_40)   // R2
#define BSP_LCD_DATA14          (GPIO_NUM_39)   // R3
#define BSP_LCD_DATA15          (GPIO_NUM_38)   // R4

#define BSP_LCD_SPI_CS          (GPIO_NUM_2)
#define BSP_LCD_SPI_SCK         (GPIO_NUM_11)
#define BSP_LCD_SPI_SDO         (GPIO_NUM_10)
...
#define BSP_LCD_HSYNC_BACK_PORCH        (80)
#define BSP_LCD_HSYNC_FRONT_PORCH       (80)
#define BSP_LCD_HSYNC_PULSE_WIDTH       (12)
#define BSP_LCD_VSYNC_BACK_PORCH        (15)
#define BSP_LCD_VSYNC_FRONT_PORCH       (12)
